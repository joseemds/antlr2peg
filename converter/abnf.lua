...
local grammar = {
  ...
  concatenation = V"FixedRepetition_1",
  ...
  FixedRepetition_0 = (V"rule_" * V"FixedRepetition_0" * #(V"ID" + V"EOF")) + EMPTY,
  FixedRepetition_1 = (V"repetition" * V"FixedRepetition_1") + #(V"repetition" * (tk(']') + tk('[') + tk('/') +  tk('*')  + tk(')') + tk('(') + V"STRING" + V"ID" + V"ProseValue" + V"EOF" + V"INT" + V"NumberValue")),
	EOF = EOF,
    EMPTY = EMPTY,
